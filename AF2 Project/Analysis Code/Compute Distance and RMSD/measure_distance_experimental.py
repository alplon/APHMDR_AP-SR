...
csv_location = '/home/alexanderplonski/experimental-experimental_csv'
csv1_2 = '1-2'
csv1_3 = '1-3'
csv2_3 = '2-3'
...
def measure_distance(data1, data2, csvtype):
    ...
    for dir in os.listdir(data1_directory):
        ...
        if os.path.isdir(target_directory):
            ...
            experimental1_directory = os.path.join(target_directory, dir + '_Target')
            experimental2_directory = os.path.join(data2_directory, dir, dir + '_Target')
            ...
            if os.path.exists("ligandoutput"):
                ...
                os.chdir('..')
            csv = csv_location + '/' + csvtype + '/' + target_name + '_distance_alphacarbon_experimental' + csvtype + '.csv'
            experimental_pdb = (dir + '_Target.pdb')
